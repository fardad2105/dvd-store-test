...
public class Film extends TableImpl<FilmRecord> {
    ...
    private static final long serialVersionUID = 1333788580;
     ...
     */
    public final TableField<FilmRecord, MpaaRating> RATING = createField("rating", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.mydvdstore.model.enums.MpaaRating.class), this, "");
